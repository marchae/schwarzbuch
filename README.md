...
You are done, you can visit your Symfony application on the following URL: `http://schwarzbuch.localhost` (and access Kibana on `http://schwarzbuch.localhost:81`)
...
You can also use Kibana to visualize Nginx & Symfony logs by visiting `http://schwarzbuch.localhost:81`.
